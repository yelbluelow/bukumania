...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'twitter_account' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-05-03 03:37:59',
                'modified' => '2020-05-03 03:37:59',
            ],
        ];
        parent::init();
    }
