...
class BookmarksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'bookmark_url_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'looked_status' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'favorite_status' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'looked_status' => 1,
                'favorite_status' => 1,
                'created' => '2020-05-03 03:36:53',
                'modified' => '2020-05-03 03:36:53',
                'deleted' => 1,
            ],
        ];
        parent::init();
